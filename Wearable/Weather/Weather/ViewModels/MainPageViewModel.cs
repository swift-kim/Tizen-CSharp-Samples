...
namespace Weather.ViewModels
{
    ...
    public class MainPageViewModel : ViewModelBase
    {
        ...
        public MainPageViewModel()
        {
            ...
            CheckWeatherCommand = new Command<Page>(async (p) => await ExecuteCheckWeatherCommand(p), CanExecuteCheckWeatherCommand);
        ...
        private Task ExecuteCheckWeatherCommand(Page page)
        {
